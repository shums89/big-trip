...
[Ссылка на проект](https://shums89.github.io/big-trip/)

<img width="420" height="238" src="https://up.htmlacademy.ru/assets/intensives/lite-javascript-2/2/projects/big-trip/preview.png?v=202501061017">

## Техническое задание

Начальное состояние проекта по [ссылке](https://up.htmlacademy.ru/assets/intensives/lite-javascript-2/2/projects/big-trip.zip).<br>
Ознакомиться с разметкой можно в директории `markup`.<br>
Все необходимые данные загружаются с сервера, сервер доступен по [ссылке](https://17.ecmascript.htmlacademy.pro/big-trip/).<br>
...
Сервер расположен по адресу `https://17.ecmascript.htmlacademy.pro/big-trip/`.
...
Ниже описаны структуры данных, которые отдаёт или принимает сервер, и доступные методы для обращения. Путь, указанный рядом с методом, — это часть адреса, по которому нужно обращаться к серверу. Например, по адресу https://17.ecmascript.htmlacademy.pro/big-trip/points можно сделать GET-запрос, чтобы получить все точки маршрута, а можно сделать POST-запрос, чтобы отправить созданную пользователем точку маршрута.
